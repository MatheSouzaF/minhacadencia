...
export function PomodoroWidget() {
  ...
  // Don't show on the pomodoro page — full timer is already there
  ...
  return (
    <>
      {/* FAB — positioned above the bottom nav (bottom: 72px) */}
      <button
        onClick={() => setOpen(!open)}
        className={cn(
          'fixed right-4 z-50 flex items-center gap-2 px-4 py-2.5 rounded-full cursor-pointer',
